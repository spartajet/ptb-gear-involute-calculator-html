 ...
 */
//class HTMLInputAngleKeyListner {
    fun HTMLInputElement.addAngleParaListener(iAngle: IAngle, InformationArea: HTMLDivElement) {
        this.addEventListener("keydown", { event ->
            ...
            if ("0123456789.°′″".contains(Regex(keyEvent.key))) {
                checkAngleChar(iAngle, char[0], keyEvent, InformationArea, this)
            } else if (keyEvent.code == "Backspace") {
                checkAngleChar(iAngle, 8.toChar(), keyEvent, InformationArea, this)
            } else {
    ...
    fun checkAngleChar(iAngle: IAngle, char: Char, event: KeyboardEvent, InformationArea: HTMLDivElement, htmlInputElement: HTMLInputElement) {
